...
import { useTrackTranscription } from './use-track-transcription.svelte.js';
import { useConnectionState } from './use-connection-state.svelte.js';
import { useParticipantAttributes } from './use-participant-attributes.svelte.js';
...
export function useVoiceAssistant(): VoiceAssistant {
	...
	const state: AgentState = $derived.by(() => {
